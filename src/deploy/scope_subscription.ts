...
export async function DeploySubscriptionScope(client: ResourceManagementClient, location: string,  templateLocation: string, deploymentMode: ResourceManagementModels.DeploymentMode, deploymentName: string, parametersLocation: string): Promise<Outputs> {    
